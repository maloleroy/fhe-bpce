...
impl TensorEncoder<CKKSEncoder> {
    ...
    pub fn encode_f64(&self, data: &[f64]) -> Result<Tensor<Plaintext>> {
    ...
    /// # Returns
    /// The decoded data.
    pub fn decode_f64(&self, chunk: &Tensor<Plaintext>) -> Result<Vec<f64>> {
...
impl TensorEncoder<BFVEncoder> {
    ...
    /// # Returns
    /// The encoded plaintext.
    pub fn encode_i64(&self, data: &[i64]) -> Result<Tensor<Plaintext>> {
        let mut plaintexts = Vec::new();
    ...
    /// # Returns
    /// The decoded data.
    pub fn decode_i64(&self, chunk: &Tensor<Plaintext>) -> Result<Vec<i64>> {
        let mut data = Vec::new();
    ...
    /// # Returns
    /// The encoded plaintext.
    pub fn encode_u64(&self, data: &[u64]) -> Result<Tensor<Plaintext>> {
        let mut plaintexts = Vec::new();
    ...
    /// # Returns
    /// The decoded data.
    pub fn decode_u64(&self, chunk: &Tensor<Plaintext>) -> Result<Vec<u64>> {
        let mut data = Vec::new();
